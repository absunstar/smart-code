module.exports = function init(site) {
  ...
  site.post("/api/create_invoices/add", (req, res) => {
    ...
    create_invoices_doc.remain_amount = create_invoices_doc.paid_require - create_invoices_doc.paid_up;
    ...
    if (create_invoices_doc.paid_up) {
      ...
      create_invoices_doc.total_remain = create_invoices_doc.paid_require - create_invoices_doc.total_paid_up
    };
    ...
    $create_invoices.add(create_invoices_doc, (err, doc) => {
      ...
      if (!err) {
        ...
        site.call('[create_invoices][request_service][+]', create_invoices_doc.request_service_id)
