module.exports = function init(site) {
  ...
  let client_id = '622443491605-hgn6ta42dboesi0sdskumqvphd285lab.apps.googleusercontent.com';
  let client_secret = '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';
  let googleScope = 'https://www.googleapis.com/auth/blogger';
  let authorization = site.toBase64(client_id + ':' + client_secret);
  let redirect_uri = '';
  let googleCode = '4/0afjohxny_3_ux46bdyy0jughb0yunxslwxx3nl4hojbevzoedx7vkrukybrllfuzeml6-a';
  let access_token = '';
  let refresh_token = '';
