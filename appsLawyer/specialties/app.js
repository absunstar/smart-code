module.exports = function init(site) {
  ...
  if (app.allowRoute) {
    if (app.allowRouteGet) {
      site.get(
        ...
        (req, res) => {
          res.render(app.name + "/index.html", { title: app.name, appName: req.word("Specialties"), setting: site.getSiteSetting(req.host) }, { parser: "html", compres: true });
        }
      );
    }
  ...
  site.getSpecialties = function (req) {
