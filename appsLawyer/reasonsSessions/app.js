    ...
    if (app.allowRoute) {
        if (app.allowRouteGet) {
            site.get(
                ...
                (req, res) => {
                    res.render(app.name + '/index.html', { title: app.name, appName: req.word('Reasons Sessions'), setting: site.getSiteSetting(req.host) }, { parser: 'html', compres: true });
                }
            );
        }
