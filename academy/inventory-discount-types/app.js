module.exports = function init(site) {
  ...
  site.post("/api/discount_types/add", (req, res) => {
    ...
    discount_types_doc.academy = site.get_company(req)
    discount_types_doc.branch = site.get_branch(req)

    discount_types_doc._created = site.security.getUserFinger({$req : req , $res : res})
  ...
  site.post("/api/discount_types/update", (req, res) => {
    ...
    discount_types_doc._updated = site.security.getUserFinger({$req : req , $res : res})
