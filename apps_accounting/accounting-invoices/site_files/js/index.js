    ...
    $scope.print = function () {
        ...
        if ($scope.defaultSettings.printer_program.a4_printer) {
            ...
            if ($scope.account_invoices.items && $scope.account_invoices.items.length > 7) {
                ...
                let ramain_items = $scope.account_invoices.items.length - inv_length * 7;
                ...
                for (let i_inv = 0; i_inv < inv_length; i_inv++) {
                    let s_o = { ...$scope.account_invoices };

                    s_o.items = [];
                    $scope.account_invoices.items.forEach((itm, i) => {
                        itm.$index = i + 1;
                ...
                $scope.account_invoices.items.forEach((_item, i) => {
                    _item.$index = i + 1;
                });
