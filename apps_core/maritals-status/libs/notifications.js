module.exports = function init(site) {
   ...
   let source = {
    ...
    let add_message = {en : 'New marital_state Added' , ar : 'تم إضافة حالة اجتماعية جديدة'}
    let update_message =  {en : ' marital_state updated' , ar : 'تم تعديل حالة اجتماعية'}
    let delete_message =  {en : ' marital_state dleteted' , ar : 'تم حذف حالة اجتماعية '}
