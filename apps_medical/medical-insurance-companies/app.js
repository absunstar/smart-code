module.exports = function init(site) {
  const $medical_insurance_companies = site.connectCollection("medical_insurance_companies")
  ...
  site.post("/api/medical_insurance_companies/add", (req, res) => {
    ...
    $medical_insurance_companies.find({
      ...
      if (!err && doc) {
        ...
        $medical_insurance_companies.add(medical_insurance_companies_doc, (err, doc) => {
          if (!err) {
            response.done = true
            response.doc = doc
  ...
  site.post("/api/medical_insurance_companies/update", (req, res) => {
    ...
    medical_insurance_companies_doc.edit_user_info = site.security.getUserFinger({
      $req: req,
      $res: res
    })
