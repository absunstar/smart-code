module.exports = function init(site) {
 ...
 let source = {
  ...
  let add_message = {en : 'New Store Dismantle Added' , ar : 'تم إضافة إذن تفكيك جديد'}
  let update_message =  {en : ' Store Dismantle updated' , ar : 'تم تعديل إذن تفكيك'}
  let delete_message =  {en : ' Store Dismantle dleteted' , ar : 'تم حذف إذن تفكيك '}
