module.exports = function init(site) {
  ...
  site.post("/api/stores_stock/add", (req, res) => {
    ...
    stores_stock_doc.add_user_stockfo = site.security.getUserFinger({ $req: req, $res: res })
  ...
  site.post("/api/stores_stock/update", (req, res) => {
    ...
    let stores_stock_doc = req.body
    stores_stock_doc.edit_user_stockfo = site.security.getUserFinger({ $req: req, $res: res })
  ...
  site.post("/api/stores_stock/posting", (req, res) => {
    if (req.session.user === undefined)
      res.json(response)
