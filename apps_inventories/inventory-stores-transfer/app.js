module.exports = function init(site) {
  ...
  site.post("/api/stores_transfer/add", (req, res) => {
    ...
    stores_transfer_doc.add_user_info = site.security.getUserFinger({$req : req , $res : res})
    ...
    stores_transfer_doc.company = site.get_company(req)
    ...
    $stores_transfer.add(stores_transfer_doc, (err, doc) => {
      if (!err) {
        ...
        stores_transfer_doc.items.forEach(itm => {
          ...
          itm.company = stores_transfer_doc.company,
  ...
  site.post("/api/stores_transfer/update", (req, res) => {
    ...
    let stores_transfer_doc = req.body
    stores_transfer_doc.edit_user_info = site.security.getUserFinger({$req : req , $res : res})
